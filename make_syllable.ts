...
function get_vowel_path_and_displacement(consonant: BaseConsonant, vowel: Vowel | 'a', is_debug_mode: boolean): { vowel_paths: string, consonant_horizontal_displacement: number } {
    if (vowel === 'a') {
